...
class UNet(nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.ModuleList([
            DownSamplingLayer(1, 24, dilation=1, padding=7),     # 16384 => 8192
            DownSamplingLayer(24, 48, dilation=2, padding=14),    # 4096
            DownSamplingLayer(48, 72, dilation=4, padding=28),    # 2048

            DownSamplingLayer(72, 96, dilation=1, padding=7),    # 1024
            DownSamplingLayer(96, 120, dilation=2, padding=14),   # 512
            DownSamplingLayer(120, 144, dilation=4, padding=28),  # 256
            
            DownSamplingLayer(144, 168, dilation=1, padding=7),  # 128
            DownSamplingLayer(168, 192, dilation=2, padding=14),  # 64
            DownSamplingLayer(192, 216, dilation=4, padding=28),  # 32
            
            DownSamplingLayer(216, 240, dilation=1, padding=7),  # 16
            DownSamplingLayer(240, 264, dilation=2, padding=14),  # 8
            DownSamplingLayer(264, 288, dilation=4, padding=28),  # 4
        ])
